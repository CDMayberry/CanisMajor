...
namespace EnemyHeavyNS{
	...
	const float HEALTH=15;
};

class EnemyHeavy: public virtual Enemy
{
public:
	EnemyHeavy():Enemy(){MAX_HEALTH = 100.0f; health = MAX_HEALTH=EnemyHeavyNS::HEALTH; BulletSpiralTheta = 0.0f; MOVEMENT_SPEED = EnemyNS::SPEED_BASE + EnemyHeavyNS::SPEED_BUFF;}
	void Fire();
private:
