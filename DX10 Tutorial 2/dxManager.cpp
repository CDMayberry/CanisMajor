...
void dxManager::renderScene()
{
	...
	v[1] = vertex( D3DXVECTOR3(-1,1,1), D3DXVECTOR4(1,0,0,1) );
	v[2] = vertex( D3DXVECTOR3(-1,-1,1), D3DXVECTOR4(1,0,0,1) );
	v[3] = vertex( D3DXVECTOR3(1,-1,1), D3DXVECTOR4(1,0,0,1) );

	v[4] = vertex( D3DXVECTOR3(1,1,-1), D3DXVECTOR4(1,0,0,1) );
	v[5] = vertex( D3DXVECTOR3(-1,1,-1), D3DXVECTOR4(1,0,0,1) );
	v[6] = vertex( D3DXVECTOR3(-1,-1,-1), D3DXVECTOR4(1,0,0,1) );
	v[7] = vertex( D3DXVECTOR3(1,-1,-1), D3DXVECTOR4(1,0,0,1) );
